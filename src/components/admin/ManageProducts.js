...
class CustomPaginationActionsTable extends React.Component {
  ...
  onBtnAdd =() => {
      ...
      Axios.post('http://localhost:2000/products' , {nama : namaproduk, harga , discount,category, img,deskripsi})
      .then((res) => {
  ...
  onBtnSave =() => {
    ...
    Axios.put('http://localhost:2000/products/' +this.state.editItem.id , newData)
    .then((res) => {
      this.getDataApi()
